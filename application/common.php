...
if (!function_exists('getOrderPaySn')) {
    /**
     * 生成支付订单
     * @author
     ...
     * @version 2018-09-11
     */
    function getOrderPaySn($order){
        return date('Ymd').substr(implode(NULL,array_map('ord',str_split( substr(uniqid(), 7, 13) , 1))), 0, 8).$order;
    }
